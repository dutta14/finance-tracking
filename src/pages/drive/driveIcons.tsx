...
const fileIconDetails: Record<string, ReactNode> = {
  ...
  json: (<>
    <text x="10" y="14.5" textAnchor="middle" fontSize="6" fontWeight="700" fill="currentColor" opacity="0.55">{'{}'}</text>
  </>),
  txt: (<>
  ...
  pdf: (<>
    <text x="10" y="14.5" textAnchor="middle" fontSize="5.5" fontWeight="700" fill="currentColor" opacity="0.55">PDF</text>
  </>),
}
