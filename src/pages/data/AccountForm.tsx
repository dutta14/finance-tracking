...
const AccountForm: FC<AccountFormProps> = ({
  ...
  const [allocation, setAllocation] = useState<AssetAllocation>(
    initial?.allocation || getDefaultAllocation(initial?.nature || 'asset'),
  )
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSave({
      ...
      linkedAccountId: nature === 'liability' ? linkedAccountId : undefined,
    })
  }
  ...
  return (
    <form className="data-form" onSubmit={handleSubmit}>
              ...
              <ul className="data-group-dropdown">
                {existingGroups
                  ...
                  .map(g => (
                    <li
                      key={g}
                      className={`data-group-option${g === group ? ' selected' : ''}`}
                      onMouseDown={() => {
                        setGroup(g)
      ...
      <div className="data-form-row">
        ...
        <div className="data-form-field">
          ...
          <select value={type} onChange={e => setType(e.target.value as AccountType)}>
            {getTypesForGoal(goalType).map(t => (
            ...
            return (
              <div className="data-form-field">
                ...
                <select
                  ...
                  onChange={e => setLinkedAccountId(e.target.value ? Number(e.target.value) : undefined)}
                >
      ...
      <div className="data-form-actions">
        <button type="submit" className="data-form-save">
          {initial ? 'Update' : 'Add Account'}
        </button>
        <button type="button" className="data-form-cancel" onClick={onCancel}>
          Cancel
        </button>
      </div>
    </form>
