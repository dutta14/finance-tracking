...
const STATIC_TOOLS: SearchItem[] = [
  ...
  { id: 'tool-savings-growth', category: 'tool', label: 'Savings/Growth Tracker', hint: 'Break down savings vs. capital gains', icon: 'trending', keywords: ['savings', 'growth', 'tracker', 'capital gains'], route: '/tools' },
